...
public class CompanyDaoTestSuite {
    ...
    public void testNamedQueries() throws FindServiceException{
        ...
        //When
        List<Employee> employeesByLastName = employeeDao.findEmployeesByLastName("Smith");
        List<Company> companiesWithNameStartsWith = companyDao.findCompaniesWithNameStartsWith("Gre");
